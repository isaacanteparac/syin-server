...
public class Usuario {
	...
	public Usuario(Integer id, Integer id_organizaciones) throws SQLException {
		DB db=new DB();
		PreparedStatement pst = db.prepare(
				"SELECT\r\n" + 
				...
				"WHERE id = ? and id_organizaciones = ?");
		pst.setInt(1,id);
		pst.setInt(2,id_organizaciones);
		ResultSet rs=pst.executeQuery();
